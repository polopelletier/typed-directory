...
[![Build Status](https://travis-ci.org/polopelletier/typed-directory.svg?branch=master)](https://travis-ci.org/polopelletier/typed-directory)
...
Use `instance=false` if the source files export a class that __extends__ the specified type
...
Use `instance=true` if the source files export an __instance__ of the specified type
